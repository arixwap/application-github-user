...
import com.arixwap.dicoding.applicationgithubuser.database.SearchUserResponse
        ...
        client.enqueue(object : Callback<User> {
            override fun onResponse(call: Call<User>, response: Response<User>) {
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun fetchUserDetail() response.isSuccessful on FALSE: ${response.message()}"
                    )
                }
        ...
        client.enqueue(object : Callback<List<User>> {
            override fun onResponse(call: Call<List<User>>, response: Response<List<User>>) {
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun getUserList() response.isSuccessful on FALSE: ${response.message()}"
                    )
                    _isLoading.value = false
                }
            }
        ...
        client.enqueue(object : Callback<SearchUserResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun searchUser() response.isSuccessful on FALSE: ${response.message()}"
                    )
                    _isLoading.value = false
                }
            }
        ...
        client.enqueue(object : Callback<User> {
            override fun onResponse(call: Call<User>, response: Response<User>) {
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun getUserDetail() response.isSuccessful on FALSE: ${response.message()}"
                    )
                }
                _isLoading.value = false
            }
        ...
        client.enqueue(object : Callback<List<User>> {
            override fun onResponse(call: Call<List<User>>, response: Response<List<User>>) {
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun getUserFollower() response.isSuccessful on FALSE: ${response.message()}"
                    )
                    _isLoading.value = false
                }
            }
        ...
        client.enqueue(object : Callback<List<User>> {
            override fun onResponse(call: Call<List<User>>, response: Response<List<User>>) {
                if (response.isSuccessful) {
                    ...
                    Log.e(
                        TAG,
                        "fun getUserFollowing() response.isSuccessful on FALSE: ${response.message()}"
                    )
                    _isLoading.value = false
                }
            }
